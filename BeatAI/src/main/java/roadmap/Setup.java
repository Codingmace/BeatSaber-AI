...
//        System.out.println(ja.size());
		...
		int timeLength = Long2Int(((JSONObject) notes[notes.length - 1]).get("_time")); // Solve the problem of this is
																						// a double
		System.out.println(timeLength);
		String segments[] = segmentSong(timeLength, notes);

		/*
		 * Obstacles Data Type = 0 Full, 1 Duck LineIndex = Column (0,1,2,3) Left ->
		 * Right Width = # Of columns Take up (L -> R)
		 */
	...
	private static String[] segmentSong(int timeLength, Object[] notes) {
		...
		// Ignoring Bombs
		/*
		 * LineLayer = Row (0,1,2) Bottom -> Top LineIndex = Column (0,1,2,3) Left ->
		 * Right Type = Color (0 Red, 1 Blue, 3 Bomb) Time = Beat Reaches Player
		 * CutDirection 0 -> 8 0 UP, 1 DOWN, 2 LEFT, 3 RIGHT, 4 UP LEFT 5 UP RIGHT, 6
		 * DOWN LEFT, 7 DOWN RIGHT 8 ANY
		 */
...
//        	System.out.println(curNote.toString());
			...
			/*
			 * Grid 8 9 10 11 4 5 6 7 0 1 2 3
			 */
